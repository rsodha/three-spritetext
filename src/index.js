...
export default class extends three.Sprite {
  ...
  _genCanvas() {
    ...
    // paint text
    ctx.font = `${this.fontWeight} ${this.fontSize}px ${this.fontFace}`; // Set font again after canvas is resized, as context properties are reset
    ...
    for (let index = 0; index < lines.length; index++) {
      ...
      if (index >= 2)
        ctx.font = `${"normal"} ${this.fontSize}px ${this.fontFace}`;
